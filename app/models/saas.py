...
class Tenant(Base):
    ...
    branding: Mapped[dict[str, str | int | bool | None]] = mapped_column(
...
class Organization(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)
    settings: Mapped[dict[str, str | int | bool | None]] = mapped_column(
        JSON, nullable=False, default=dict
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), server_default=func.now(), nullable=False
...
class UsageRecord(Base):
    ...
    usage_metadata: Mapped[dict[str, str | int | float | bool | None]] = mapped_column(
...
class ApiKey(Base):
    ...
    key_scope: Mapped[str] = mapped_column(String(32), nullable=False)
    expires_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
...
class AffiliateInsight(Base):
    __tablename__ = "affiliate_ai_insights"
